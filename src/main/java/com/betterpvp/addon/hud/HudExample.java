package com.betterpvp.addon.hud;
...
public class HudExample extends HudElement {
     ...
     */
    public static final HudElementInfo<HudExample> INFO = new HudElementInfo<>(BetterPvP.HUD_GROUP, "example", "HUD element example.", HudExample::new);
